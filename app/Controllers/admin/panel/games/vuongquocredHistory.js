...
module.exports = function(req, res) {
    ...
    UserInfo.find({
        ...
        VuongQuocRedRed.countDocuments(filter).exec(function(err, totals) {
            VuongQuocRedRed.find(filter, {}, { sort: { '_id': -1 }, skip: Data.offset, limit: Data.limit }, function(error, result) {
                res.json({
                    status: 200,
                    success: true,
                    totals: totals,
